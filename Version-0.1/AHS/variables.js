...
//Put site abbreviation here ex. {HPD}.srotips.org
var abrv = "apd";

//Site title like MPD or HPD Tips
var siteTitle = "APD Tips";
...
var GString = "11a3QUAJZGzQXLEuaMd3BGVXWOwsYN6s11k9teodGH6c";

//Site Header ex. HPD Anonymous Tip Tool
var siteHeader = "APD Anonymous Tip Tool";

/*----------------------------------------------------------*/
/*submitted.html variables*/

//Police Department Name ex. Hollis Police Department
var pdName = "Amherst Police Department";

//Police Department Phone Number
var pdPhone = "603-673-4900";

//Link to Police Department Website URL
var pdLink = "http://amherstnh.gov/emergency-services/police-department/";

//Link to Police Department Image
var pdImage = "http://amherstnh.gov/wp-content/uploads/2010/09/NewStationPhoto.jpg";

//School's abbreviation ex. HBHS
var schoolAbrv = "SHS";

//SRO's Name
var sroName = "John Smith";

//Main chunk of SRO Email ex. juanathan39@gmail.com
var sroEmail = "Jsmith@sprise.com";
...
//Complete Hidden Link
var hiddenlinkHTML = "http://" + String(abrv) + ".srotips.org/chat/lhc_web/index.php/site_admin/";

var javaURL = "\'//" + String(abrv) + ".srotips.org/chat/lhc_web/index.php/chat/getstatusembed\'";
