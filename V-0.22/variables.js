...
var siteTitle = "Hollis Anonymous Tip";
...
var siteHeader = "Hollis Anonymous Tip Tool";
...
function fileupload() {
    ...
    if (document.getElementById("entry_1131071639").value.length > 2) {
        if (document.getElementById("entry_3915226").selectedIndex > 0) {
            ...
            if (document.getElementById("file-name").getAttribute("value").length > 2) {
                document.getElementById("entry_1029523308").setAttribute("value", String(document.getElementById("file-name").getAttribute("value")));
            }
        }
    }
}
...
/*-----------------------------------------------------------*/
/* // Outlines and explains each line of the function (Not all are used in final product)
//inserts <title>
function title() {
    "use strict";
    document.getElementById("siteTitle").innerHTML = siteTitle;
